...
function AccHero() {
  ...
  return (
    ...
    <div className="bg-[url('/assets/the-anam-ex_DealC5Kk-unsplash.jpg')] bg-no-repeat bg-cover h-[100vh] -top-[10vh] w-full relative text-black flex justify-center items-center">
