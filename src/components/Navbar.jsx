...
//     return (
//         <nav className="w-full h-fit py-2 flex flex-col justify-center items-center sticky top-0 z-50 bg-white">
...
//                         <a
//                          className="leading-normal no-underline text-black text-lg hover:text-black cursor-pointer"
//                          onClick={() => navigate("/")}
//                         >
//                          Home
//                         </a>
//                         {/* <a href="#" className="leading-normal no-underline text-light text-lg hover:text-black">Activity</a>
//                         <a href="Accommodation" className="leading-normal no-underline text-light text-lg hover:text-black" >Accommodation</a> */}
